...
const BADGES = [
  ...
  { type: "BOOK_100",        name: "100 Kitob",           icon: "👑", description: "100 ta kitobni o'qib tugatdi",   requirement: 100 },
  { type: "BOOK_PAGES_100",  name: "100 Bet Kitob",       icon: "📄", description: "100 bet kitob o'qidi",           requirement: 100 },
  { type: "BOOK_PAGES_500",  name: "500 Bet Kitob",       icon: "📚", description: "500 bet kitob o'qidi",           requirement: 500 },
  { type: "BOOK_PAGES_1000", name: "1000 Bet Kitob",      icon: "📗", description: "1000 bet kitob o'qidi",          requirement: 1000 },
  { type: "BOOK_PAGES_5000", name: "5000 Bet Kitob",      icon: "🗂️", description: "5000 bet kitob o'qidi",          requirement: 5000 },
  { type: "BOOK_PAGES_10000", name: "10 000 Bet Kitob",   icon: "🏔️", description: "10000 bet kitob o'qidi",         requirement: 10000 },
  { type: "BOOK_PAGES_25000", name: "25 000 Bet Kitob",   icon: "📚", description: "25000 bet kitob o'qidi",         requirement: 25000 },
