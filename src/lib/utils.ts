...
export const BADGE_CONFIG = {
  ...
  KHATM_CREATOR_10:{ name: "10 Xatm Yaratuvchi",  icon: "👑", description: "10 ta xatm yaratdi"           },
  STREAK_3:        { name: "3 Kun Streak",        icon: "⚡", description: "3 kun ketma-ket faol"          },
  ...
  STREAK_60:       { name: "60 Kun Streak",       icon: "🌙", description: "60 kun ketma-ket faol"         },
  ...
  BOOK_50:         { name: "50 Kitob",            icon: "📖", description: "50 ta kitobni o'qib tugatdi"    },
  JUZ_1:           { name: "Ilk Pora",            icon: "🕌", description: "1 ta porani to'liq o'qidi"      },
  ...
  JUZ_100:         { name: "100 Pora",            icon: "📚", description: "100 ta porani to'liq o'qidi"    },
  PAGES_1:         { name: "Ilk Qadam",           icon: "👣", description: "1 sahifa Qur'on o'qidi"         },
  PAGES_100:       { name: "100 Sahifa",          icon: "🍃", description: "100 sahifa Qur'on o'qidi"       },
  PAGES_500:       { name: "500 Sahifa",          icon: "📄", description: "500 sahifa Qur'on o'qidi"       },
  PAGES_1000:      { name: "1000 Sahifa",         icon: "📗", description: "1000 sahifa Qur'on o'qidi"      },
  PAGES_5000:      { name: "5000 Sahifa",         icon: "🗂️", description: "5000 sahifa Qur'on o'qidi"      },
  PAGES_10000:     { name: "10 000 Sahifa",       icon: "🏔️", description: "10000 sahifa Qur'on o'qidi"     },
  ACTIVE_30:       { name: "30 Faol Kun",         icon: "📅", description: "30 kunlik faollik"              },
  ACTIVE_100:      { name: "100 Faol Kun",        icon: "🗓️", description: "100 kunlik faollik"             },
  COINS_1000:      { name: "1000 BuloqCoin",      icon: "💰", description: "1000 BuloqCoin to'pladi"        },
  COINS_5000:      { name: "5000 BuloqCoin",      icon: "💎", description: "5000 BuloqCoin to'pladi"        },
} as const;
